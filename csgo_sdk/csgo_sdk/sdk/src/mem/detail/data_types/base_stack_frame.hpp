...
namespace sdk::detail {
    ...
    struct base_stack_frame_t final : public base_address_t< _addr_t > {
        ...
        ALWAYS_INLINE constexpr base_stack_frame_t(
            const _addr_t addr = reinterpret_cast< _addr_t >( _AddressOfReturnAddress( ) ) - sizeof( _addr_t )
        ) : base_t{ addr } {}
        ...
        ALWAYS_INLINE base_stack_frame_t< _addr_t >& self_next( ) { return base_t::self_deref( 1u ); }
