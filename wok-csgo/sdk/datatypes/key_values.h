...
public:
	...
	VFUNC_SIG(find_key(const char* name, bool create), "client.dll", "55 8B EC 83 EC 1C 53 8B D9 85 DB", key_values*(__thiscall*)(void*, const char*, bool), name, create)
	...
	void set_string(const char* name, const char* a2) {
		...
		static auto set_string_fn = reinterpret_cast<void(__thiscall*)(void*, const char*)>(SIG("client.dll", "55 8B EC A1 ? ? ? ? 53 56 57 8B F9 8B 08 8B 01"));
